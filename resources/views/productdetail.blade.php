@include('header')
    ...
    <div class="col-5">
     <center><h3>Samsung Galaxy S4 I337 16GB 4G LTE Unlocked GSM Android Cell Phone</h3>    
  ...
  <div class="item">
    <div class="content">
        <img style="width: 20px; height: 20px;" src="img/detail/place.png" alt="#">
      <strong>Địa chỉ</strong>
      <div class="description">Hồ Chí Minh,Quận 1,Phường Phạm Ngũ Lão</div>
    </div>
  </div>
  <div class="item">
    <div class="content">
        <img style="width: 20px; height: 20px;" src="img/detail/message.png" alt="#">
   ...
   <div class="item">
    <div class="content">
      <strong>Krolewskie Jadlo</strong>
      <div class="description">An excellent polish restaurant, quick delivery and hearty, filling meals.</div>
    </div>
  </div>
  <div class="item">
